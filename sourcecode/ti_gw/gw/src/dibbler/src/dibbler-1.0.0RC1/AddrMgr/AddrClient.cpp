...
// UNIHAN ADD
    ...
    if ( x.Broadband_DeviceManufacturerOUI.length() > 0)
    {
        strum << "    <DeviceManufacturerOUI length=\"" << x.Broadband_DeviceManufacturerOUI.length() << "\">"
            << x.Broadband_DeviceManufacturerOUI << "</DeviceManufacturerOUI>" << endl;
    }
    else 
    {
    ...
    // DeviceSerialNumber
    if ( x.Broadband_DeviceSerialNumber.length() > 0 )
    {
        strum << "    <DeviceSerialNumber length=\"" << x.Broadband_DeviceSerialNumber.length() << "\">"
            << x.Broadband_DeviceSerialNumber << "</DeviceSerialNumber>" << endl;
    }
    else
    {
    ...
    // DeviceProductClass
    if (x.Broadband_DeviceProductClass.length() > 0 )
    {
        strum << "    <DeviceProductClass length=\"" << x.Broadband_DeviceProductClass.length() << "\">"
            << x.Broadband_DeviceProductClass << "</DeviceProductClass>" << endl;
    }
    else
    {
