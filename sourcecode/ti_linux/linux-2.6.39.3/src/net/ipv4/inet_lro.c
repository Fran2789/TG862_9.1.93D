					  ...
					  u16 vlan_tag, void *priv, __wsum sum)
{
	...
	{
		// ARRIS MOD : don't use void pointers in arithmetic - use u8 - PW.NONOBJECT_POINTER_ARITHMETIC
		mac_hdr = (void *)((u8 *)page_address(frags->page) + frags->page_offset);
		// END ARRIS
		goto out1;
	}
	...
	// ARRIS MOD : don't use void pointers in arithmetic - use u8 - PW.NONOBJECT_POINTER_ARITHMETIC
	hdr_len = (int)((u8 *)(tcph) + TCP_HDR_LEN(tcph) - (u8 *)mac_hdr);
	mac_hdr_len = (int)((u8 *)(iph) - (u8 *)mac_hdr);
	// END ARRIS
