...
/* ARRIS MOD BEGIN */
/* In order to actually use these ioctl definitions from user space, the 
 * header needs to be exported, which, in turn, means it needs to be in the <linux base>/include
 * path.  I have placed the contents of this file in a new file located there. 
 * I'm leaving this file here, for when we merge Intel drops 
 */

#include <asm-arm/arch-avalanche/generic/cpgmac_f_ioctl.h>
