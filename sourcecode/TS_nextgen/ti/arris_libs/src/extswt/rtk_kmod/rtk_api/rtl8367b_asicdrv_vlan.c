...
ret_t rtl8367b_setAsicVlan4kEntry(rtl8367b_user_vlan4kentry *pVlan4kEntry )
{
    ...
    PRINT( "rtl8367b_setAsicVlan4kEntry : vid %d - mbr: 0x%04x, utg: 0x%04x\n",
           pVlan4kEntry->vid, pVlan4kEntry->mbr, pVlan4kEntry->untag );
...
ret_t rtl8367b_getAsicVlan4kEntry(rtl8367b_user_vlan4kentry *pVlan4kEntry )
{
    ...
    PRINT( "rtl8367b_getAsicVlan4kEntry : vid %d - mbr: 0x%04x, utg: 0x%04x\n",
           pVlan4kEntry->vid, pVlan4kEntry->mbr, pVlan4kEntry->untag );
