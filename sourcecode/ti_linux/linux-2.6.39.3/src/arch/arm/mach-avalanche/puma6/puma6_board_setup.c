...
void avalanche_soc_platform_init(void)
{
     ...
     **************************************************************/
     ...
     PAL_sysResetCtrl(AVALANCHE_UART1_RESET, OUT_OF_RESET); // ARRIS ADD - enable UART1 for DECT
...
//     PAL_sysResetCtrl(CRU_NUM_TDM01, OUT_OF_RESET);
     ...
     **************************************************************/
     ...
     PAL_sysBootCfgCtrl_DocsisIo_UART1(BOOTCFG_IO_ENABLE);  /* Open UART-1 IOs */ // ARRIS ADD - enable UART1 for DECT
