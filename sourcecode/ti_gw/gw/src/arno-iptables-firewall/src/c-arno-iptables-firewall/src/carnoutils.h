...
/*SERCOMM ADD*/
/*ADD this for setting IPv4/IPv6 rules separately*/
typedef enum {
    ARNO_SETTING_TYPE_ALL = 0,
    ARNO_SETTING_TYPE_IPV4,
    ARNO_SETTING_TYPE_IPV6
} ARNO_SETTING_TYPE_e;
extern ARNO_SETTING_TYPE_e g_Setting_RuleType; /*in carnomain.c*/
/*END SERCOMM ADD*/

//UNIHAN ADD START 
typedef enum {
    ARNO_STATUS_TABLE_ALL = 0,
    ARNO_STATUS_TABLE_FILTER,
    ARNO_STATUS_TABLE_NAT,
    ARNO_STATUS_TABLE_MANGLE
} ARNO_STATUS_TABLE_e;
extern ARNO_STATUS_TABLE_e g_Status_TableType; /*in carnomain.c*/
//END UNIHAN ADD
