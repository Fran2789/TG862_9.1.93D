...
*****************************************************************************/
#include <linux/kernel.h> // ARRIS ADD for EXPORT_SYMBOL
#include <linux/module.h> // ARRIS ADD for EXPORT_SYMBOL
...
EXPORT_SYMBOL(cpswHalCommonMiiMdioInit); // ARRIS ADD - export for access from Moca
...
EXPORT_SYMBOL(cpswHalCommonMiiMdioGetPhyDevSize); // ARRIS ADD - export for access from Moca
  ...
  if(_cpswHalIsAgerePhy(PhyDev,PhyNum))
   {
       ...
       */
//      _cpswHalCommonMiiMdioSetPhyTrim(PhyDev,PhyNum); ARRIS remove.  this messes up both Agere and Marvell PHYs
...
EXPORT_SYMBOL(_cpswHalCommonMiiMdioUserAccessRead); // ARRIS ADD - export for access from Moca
...
EXPORT_SYMBOL(_cpswHalCommonMiiMdioUserAccessWrite); /// ARRIS ADD - export for access from Moca
