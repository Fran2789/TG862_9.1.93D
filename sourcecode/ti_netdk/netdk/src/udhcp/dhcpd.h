...
#define DHCP_FINGERPRINTS_CONF_FILE     "/var/tmp/dhcp_fingerprints.conf"
...
#define DHCP_VENDORID_VENDORCLASS    0x7c /* 124 */
#define DHCP_VENDORID_VENDORSPECIFIC    0x7d /* 125 */
#define IANA_ENTERPRISE_BROADBAND_FORUM   0xde9 /* 3561 */
#define BROADBAND_SUBOPT_DEVICE_MANUFACTUREROUI    0x01
#define BROADBAND_SUBOPT_DEVICE_SERIALNUMBER     0x02
#define BROADBAND_SUBOPT_DEVICE_PRODUCTCLASS     0x03
#define BROADBAND_SUBOPT_GW_MANUFACTUREROUI     0x04
#define BROADBAND_SUBOPT_GW_SERIALNUMBER     0x05
#define BROADBAND_SUBOPT_GW_PRODUCTCLASS     0x06
#define BROADBAND_SUBOPT_ACS_URL    0x0b /* 11 */
#define BROADBAND_SUBOPT_PROVISIONING_CODE    0x0c /* 12 */
#define BROADBAND_SUBOPT_CWMP_RETRY_MINIMUM_WAIT_INTERVAL    0x0d /* 13 */
#define BROADBAND_SUBOPT_CWMP_RETRY_INTERVAL_MULTIPLIER     0x0e /* 14 */
...
struct tr69_config_t
{
    int enable;
    char *provision_code;
    char *acs_url;
    char* retry_wait_interval;
    char* retry_interval_multi;
};
#endif
/* ARRIS ADD END */
...
/*UNIHAN ADDED START */
    ...
    char *Custom_file;               /* To support LanCustom */
#endif
/*UNIHAN ADDED END */
	char *pidfile;
  ...
  struct dhcpOfferedAddr *leases;  
    ...
    char *vendorinfo;
// UNIHAN ADD START, to support static lease
    char *static_lease_file;
    struct static_lease *static_leases; /* List of ip/mac pairs to assign static leases */
// UNIHAN ADD END
// UNIHAN ADD START, to support CPE aging
    u_int32_t cpe_aging_base; /* timeout base in seconds to clean all expired leases */
    u_int32_t cpe_aging_time; /* real timeout in seconds to clean all expired leases */
// UNIHAN ADD END
    //char *vendor125_OptionInfo;  /* option 125 from the vendor_option_file */
 
/* ARRIS ADD START */
#if defined(INCLUDE_ARRIS_GW_TR69) && !defined(CONFIG_VENDOR_ARRIS_CM_TR69)
    char *option125_gwsn; //option 125 suboption 5 - GatewaySerialNumber
    char *option125_gwpclass; //option 125 suboption:6 - GatewayProductClass
#endif
/* ARRIS ADD END */
};	
...
char *vendor125_OptionInfo;  /* option 125 from the vendor_option_file */
char *vendor_option_file;    /* file that keeps option 125 received from DHCP Client */
int  vendor_option_flag;     /* indicates that the Vendor Specific information shall be updated */
int  write_all_leases_flag;  /* ARRIS ADD */
int  exit_flag;              /* ARRIS ADD */ 

extern char *vendor125_OptionInfo;
extern char *vendor_option_file;
extern int  vendor_option_flag;
