...
#endif
// ARRIS ADD
#ifdef CONFIG_ARM_AVALANCHE_BCM_53125S
#include "csl_bcm53125S.h"
#endif
// END ARRIS ADD
...
// ARRIS ADD
   ...
   cslBcm53125S_global_init( pCslSwitchClbks );
   cslBcm53125S_vlan_init  ( pCslSwitchClbks );
   cslBcm53125S_portvlan_init( pCslSwitchClbks );
