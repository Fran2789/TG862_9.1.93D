...
**     30-Nov-2011: changed my_log function to a wrapper 
**     30-Nov-2011: calling fprintf instead of syslog
**     30-Nov-2011: other reworks ans simplifications 
**  
...
{
    char LogMsg[ 256 ]; /* ARRIS MOD - log msg truncating was observed */
