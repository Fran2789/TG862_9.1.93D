...
public:
    ...
    struct gwdb_config_t
    {
        int tr69_enable;
        int tr69_v6_retry_wait_interval;
        int tr69_v6_retry_interval_multi;
        char *tr69_v6_acs_url;
        char *tr69_v6_provision_code;
        char *vendor_id;
        char *serial_number;
        char *hw_model;
    };
    struct gwdb_config_t gwdb_config = { 
                                         .tr69_enable = -1, 
                                         .tr69_v6_retry_wait_interval = -1, 
                                         .tr69_v6_retry_interval_multi = -1, 
                                         .tr69_v6_acs_url = NULL, 
                                         .tr69_v6_provision_code = NULL, 
                                         .vendor_id = NULL, 
                                         .serial_number = NULL, 
                                         .hw_model = NULL 
                                       };
...
#if defined(INCLUDE_ARRIS_GW_TR69) && !defined(CONFIG_VENDOR_ARRIS_CM_TR69)
    bool appendBroadBandVendorSpec(bool isGetDeviceIdentity, bool isGetDslForumString);
    bool updateBroadBandVendorSpec();
#endif //defined(INCLUDE_ARRIS_GW_TR69) && !defined(CONFIG_VENDOR_ARRIS_CM_TR69)
