...
extern int (*sc_ppm_create_session_hook)( TI_PP_SESSION* ptr_session, void *ptr );
extern int (*sc_modify_pp_info_hook)( TI_PP_SESSION* ptr_session, void *ptr );
EXPORT_SYMBOL(sc_ppm_create_session_hook);
EXPORT_SYMBOL(sc_modify_pp_info_hook);
#endif // INCLUDE_SERCOMM_GW
ARRISMOD_DEFINE( int, arris_rip_create_pp_session_hook, TI_PP_SESSION*, void* );
#endif // Comcast