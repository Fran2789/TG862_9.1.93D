...
/*
http://linuxfocus.org/English/February2005/article367.shtml
******************************************************************************************************
 ...
 * -  modified parser, save, check functions, etc.
 ******************************************************************************************************
*/
...
static void TRIGGER_save(const void *ip, const struct xt_entry_target *target)
{
    ...
    /* ARRIS MOD START */
    /* iptables-save dumps trigger parameters out of the air, and trigger-type */
