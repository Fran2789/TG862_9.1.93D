...
// ARRIS DELETE BEGIN : Move ioctl info to an exported header
#if 0
...
#endif
// ARRIS DELETE END : Move ioctl info to an exported header
...
// ARRIS DELETE BEGIN : Move IOCTL related info to and exported header file
#if 0
...
#endif
// ARRIS DELETE END : Move IOCTL related info to and exported header file
...
/* ARRIS ADD BEGIN : Custom Switch API additions */
...
PAL_Result switch_arrisSetCertConfig(void);
PAL_Result switch_arrisBounceLink(void);
/* ARRIS ADD END : Custom Switch API additions */
