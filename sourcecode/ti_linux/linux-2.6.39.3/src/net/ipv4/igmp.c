...
/* ARRIS ADD START */
/* RFC 3376 (IGMPv3) :default value of "Unsolicited Report Interval" is 1 second */
#define IGMP_V3_Unsolicited_Report_Interval (HZ)
/* ARRIS ADD END */
...
static void igmp_ifc_timer_expire(unsigned long data)
{
	...
	if (in_dev->mr_ifc_count) {
		in_dev->mr_ifc_count--;
        /* ARRIS MOD START */
		igmp_ifc_start_timer(in_dev, IGMP_V3_Unsolicited_Report_Interval);
        /* ARRIS MOD END */
	}
	__in_dev_put(in_dev);
}
...
static void igmp_timer_expire(unsigned long data)
{
	...
	if (im->unsolicit_count) {
		im->unsolicit_count--;
        /* ARRIS MOD START */
        /* Unsolicited Report Interval for IGMPv3 should be 1 second (RFC 3376) */
        if (IGMP_V1_SEEN(in_dev) || IGMP_V2_SEEN(in_dev)){
    		igmp_start_timer(im, IGMP_Unsolicited_Report_Interval);
        }
        else {
            igmp_start_timer(im, IGMP_V3_Unsolicited_Report_Interval);
        }
        /* ARRIS MOD END */
	}
	im->reporter = 1;
