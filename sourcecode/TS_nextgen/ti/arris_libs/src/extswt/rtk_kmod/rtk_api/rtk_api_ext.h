 ...
 */
extern rtk_api_ret_t rtk_stat_port_getAll_IfTable(rtk_port_t port, rtk_stat_port_cntr_t *pPort_cntrs);
/* ARRIS ADD END */
...
/* ARRIS ADD BEGIN */
/* Function Name:
 *      rtk_phy_portEnable_get
 * Description:
 *      get the phy power state on port
 * Input:
 *      port        - Port ID
 * Output:
 *      pEnable     - Power down/on (0/1)
 * Return:
 *      RT_ERR_OK              - OK
 *      RT_ERR_PORT_ID         - Error Port ID
 *      RT_ERR_NULL_POINTER    - Null pointer
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_phy_portEnable_get(rtk_port_t port, rtk_enable_t *pEnable);

/* Function Name:
 *      rtk_phy_portEnable_set
 * Description:
 *      set the phy power state on port
 * Input:
 *      port        - Port ID
 *      enable      - Power down/on (0/1)
 * Output:
 *      None.
 * Return:
 *      RT_ERR_OK              - OK
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_phy_portEnable_set(rtk_port_t port, rtk_enable_t enable);
/* ARRIS ADD END */
