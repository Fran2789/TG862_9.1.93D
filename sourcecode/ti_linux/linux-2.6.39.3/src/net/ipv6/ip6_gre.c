...
/* ARRIS DELETE START */
/* SERCOMM added it addrconf.h */
#if 0
static u32 ipv6_addr_hash(const struct in6_addr *addr);
/*this function is defined in kernel 3.7 inside ipv6.h
to comply with the current kernel version we use(2.6.39.3),
this function had to be removed from ipv6.h and to bwe defined here staticly.
when moving to a higher kernel version ,ipv6_addr_hash will need to be removed from here */
static u32 ipv6_addr_hash(const struct in6_addr *addr)
{
    /*
