...
/*SERCOMM ADD*/
void (*sc_hotspot_vlan_pri_hook)(struct net_device *dev, struct sk_buff *skb) = NULL; /*used to set vlan priority*/
EXPORT_SYMBOL(sc_hotspot_vlan_pri_hook);
/*SERCOMM ADD END*/
...
{
#if (CONFIG_MACH_PUMA6) || (CONFIG_MACH_PUMA5)
/*SERCOMM ADD*/
    if(sc_hotspot_vlan_pri_hook) {
        sc_hotspot_vlan_pri_hook(dev, skb);
    }
/*SERCOMM ADD END*/
