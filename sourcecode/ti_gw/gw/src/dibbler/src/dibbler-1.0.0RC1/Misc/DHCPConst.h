...
#define DHCPV6_OPTION_FILE "dhcp_client_"
#define DHCPV6_OPTION_FILE_PATH "/var/tmp/"
// UNIHAN ADD END
...
#define BROADBAND_DSL_FORUM_STRING    "dslforum.org"
#define BROADBAND_V6SUBOPT_ACS_URL    0x01 /* 1 */
#define BROADBAND_V6SUBOPT_PROVISIONING_CODE    0x02 /* 2 */
#define BROADBAND_V6SUBOPT_CWMP_RETRY_MINIMUM_WAIT_INTERVAL    0x03 /* 3 */
#define BROADBAND_V6SUBOPT_CWMP_RETRY_INTERVAL_MULTIPLIER     0x04 /* 4 */
#define BROADBAND_V6SUBOPT_DEVICE_MANUFACTUREROUI    0x0b /* 11 */
#define BROADBAND_V6SUBOPT_DEVICE_SERIALNUMBER     0x0c /* 12 */
#define BROADBAND_V6SUBOPT_DEVICE_PRODUCTCLASS     0x0d /* 13 */
#define BROADBAND_V6SUBOPT_GW_MANUFACTUREROUI    0x0e /* 14 */
#define BROADBAND_V6SUBOPT_GW_SERIALNUMBER     0x0f /* 15 */
#define BROADBAND_V6SUBOPT_GW_PRODUCTCLASS     0x10 /* 16 */
