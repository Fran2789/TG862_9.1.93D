...
// UNIHAN MOD START for PROD00217071
#if (CONFIG_MACH_PUMA5)
#define L2SW_NETDEV_DATA0       "eth0"
#else
#define L2SW_NETDEV_DATA0       "l2sd0"
#endif
// UNIHAN MOD END for PROD00217071
...
#ifdef __KERNEL__
extern void set_proxy_pdsp_running (Bool ProxyStatus);
#endif
